...
export type RequestType = RequestType_BabeEpoch | RequestType_Local

export interface RequestType_BabeEpoch {
    __kind: 'BabeEpoch'
    value: bigint
}

export interface RequestType_Local {
    __kind: 'Local'
    value: number
}

export interface RandomnessResult {
    randomness: (Uint8Array | undefined)
    requestCount: bigint
}
...
export type RequestInfo = RequestInfo_BabeEpoch | RequestInfo_Local

export interface RequestInfo_BabeEpoch {
    __kind: 'BabeEpoch'
    value: [bigint, bigint]
}

export interface RequestInfo_Local {
    __kind: 'Local'
    value: [number, number]
}

...
export type Event = Event_System | Event_ParachainSystem | Event_Balances | Event_ParachainStaking | Event_AuthorFilter | Event_AuthorMapping | Event_Utility | Event_Proxy | Event_MaintenanceMode | Event_Identity | Event_Migrations | Event_EVM | Event_Ethereum | Event_BaseFee | Event_Scheduler | Event_Democracy | Event_CouncilCollective | Event_TechCommitteeCollective | Event_Treasury | Event_CrowdloanRewards | Event_XcmpQueue | Event_CumulusXcm | Event_DmpQueue | Event_PolkadotXcm | Event_Assets | Event_AssetManager | Event_XTokens | Event_XcmTransactor
...
export interface SchedulerEvent_Dispatched {
    __kind: 'Dispatched'
    value: [[number, number], (Uint8Array | undefined), Type_41]
}
 ...
 */
export type AssetManagerEvent = AssetManagerEvent_AssetRegistered | AssetManagerEvent_UnitsPerSecondChanged | AssetManagerEvent_AssetTypeChanged
...
export interface AssetManagerEvent_UnitsPerSecondChanged {
    ...
    value: [AssetType, bigint]
}

export interface AssetManagerEvent_AssetTypeChanged {
    __kind: 'AssetTypeChanged'
    value: [bigint, AssetType]
}
...
export interface XcmTransactorEvent_TransactInfoChanged {
    ...
    value: [V1MultiLocation, RemoteTransactInfoWithMaxWeight]
}

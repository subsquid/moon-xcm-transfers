...
export type Event = Event_System | Event_ParachainSystem | Event_Balances | Event_TransactionPayment | Event_ParachainStaking | Event_AuthorFilter | Event_AuthorMapping | Event_MoonbeamOrbiters | Event_Utility | Event_Proxy | Event_MaintenanceMode | Event_Identity | Event_Migrations | Event_EVM | Event_Ethereum | Event_BaseFee | Event_Scheduler | Event_Democracy | Event_Preimage | Event_CouncilCollective | Event_TechCommitteeCollective | Event_TreasuryCouncilCollective | Event_Treasury | Event_CrowdloanRewards | Event_XcmpQueue | Event_CumulusXcm | Event_DmpQueue | Event_PolkadotXcm | Event_Assets | Event_AssetManager | Event_XTokens | Event_XcmTransactor | Event_LocalAssets | Event_Randomness

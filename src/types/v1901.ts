...
export interface CollatorSnapshot {
    bond: bigint
    delegations: BondWithAutoCompound[]
    total: bigint
}
...
export interface BondWithAutoCompound {
    owner: Uint8Array
    amount: bigint
    autoCompound: number
}
...
export type Event = Event_System | Event_ParachainSystem | Event_Balances | Event_TransactionPayment | Event_ParachainStaking | Event_AuthorFilter | Event_AuthorMapping | Event_MoonbeamOrbiters | Event_Utility | Event_Proxy | Event_MaintenanceMode | Event_Identity | Event_Migrations | Event_EVM | Event_Ethereum | Event_BaseFee | Event_Scheduler | Event_Democracy | Event_CouncilCollective | Event_TechCommitteeCollective | Event_TreasuryCouncilCollective | Event_Treasury | Event_CrowdloanRewards | Event_XcmpQueue | Event_CumulusXcm | Event_DmpQueue | Event_PolkadotXcm | Event_Assets | Event_AssetManager | Event_XTokens | Event_XcmTransactor | Event_LocalAssets | Event_Randomness
...
export interface Event_TreasuryCouncilCollective {
    __kind: 'TreasuryCouncilCollective'
    value: TreasuryCouncilCollectiveEvent
}
...
export interface Event_Randomness {
    __kind: 'Randomness'
    value: RandomnessEvent
}
 ...
 */
export interface ParachainStakingEvent_AutoCompoundSet {
    __kind: 'AutoCompoundSet'
    candidate: Uint8Array
    delegator: Uint8Array
    value: number
}
 ...
 */
export interface ParachainStakingEvent_Compounded {
    __kind: 'Compounded'
    candidate: Uint8Array
    delegator: Uint8Array
    amount: bigint
 ...
 */
export type AuthorMappingEvent = AuthorMappingEvent_KeysRegistered | AuthorMappingEvent_KeysRemoved | AuthorMappingEvent_KeysRotated

/**
 * A NimbusId has been registered and mapped to an AccountId.
 */
export interface AuthorMappingEvent_KeysRegistered {
    __kind: 'KeysRegistered'
    nimbusId: Uint8Array
 ...
 */
export interface AuthorMappingEvent_KeysRemoved {
    __kind: 'KeysRemoved'
    nimbusId: Uint8Array
    accountId: Uint8Array
    keys: Uint8Array
 ...
 */
export interface AuthorMappingEvent_KeysRotated {
    __kind: 'KeysRotated'
    newNimbusId: Uint8Array
    accountId: Uint8Array
    newKeys: Uint8Array
 ...
 */
export type MoonbeamOrbitersEvent = MoonbeamOrbitersEvent_OrbiterJoinCollatorPool | MoonbeamOrbitersEvent_OrbiterLeaveCollatorPool | MoonbeamOrbitersEvent_OrbiterRewarded | MoonbeamOrbitersEvent_OrbiterRotation | MoonbeamOrbitersEvent_OrbiterRegistered | MoonbeamOrbitersEvent_OrbiterUnregistered
 ...
 */
export interface MoonbeamOrbitersEvent_OrbiterRegistered {
    __kind: 'OrbiterRegistered'
    account: Uint8Array
    deposit: bigint
}
 ...
 */
export interface MoonbeamOrbitersEvent_OrbiterUnregistered {
    __kind: 'OrbiterUnregistered'
    account: Uint8Array
}
 ...
 */
export type TreasuryCouncilCollectiveEvent = TreasuryCouncilCollectiveEvent_Proposed | TreasuryCouncilCollectiveEvent_Voted | TreasuryCouncilCollectiveEvent_Approved | TreasuryCouncilCollectiveEvent_Disapproved | TreasuryCouncilCollectiveEvent_Executed | TreasuryCouncilCollectiveEvent_MemberExecuted | TreasuryCouncilCollectiveEvent_Closed

/**
 * A motion (given hash) has been proposed (by given account) with a threshold (given
 * `MemberCount`).
 */
export interface TreasuryCouncilCollectiveEvent_Proposed {
    __kind: 'Proposed'
    account: Uint8Array
    proposalIndex: number
    proposalHash: Uint8Array
 ...
 * a tally (yes votes and no votes given respectively as `MemberCount`).
 */
export interface TreasuryCouncilCollectiveEvent_Voted {
    __kind: 'Voted'
    account: Uint8Array
    proposalHash: Uint8Array
    voted: boolean
 ...
 * A motion was approved by the required threshold.
 */
export interface TreasuryCouncilCollectiveEvent_Approved {
    __kind: 'Approved'
    proposalHash: Uint8Array
}
 ...
 * A motion was not approved by the required threshold.
 */
export interface TreasuryCouncilCollectiveEvent_Disapproved {
    __kind: 'Disapproved'
    proposalHash: Uint8Array
}
 ...
 * A motion was executed; result will be `Ok` if it returned without error.
 */
export interface TreasuryCouncilCollectiveEvent_Executed {
    __kind: 'Executed'
    proposalHash: Uint8Array
    result: Type_49
}
 ...
 * A single member did some action; result will be `Ok` if it returned without error.
 */
export interface TreasuryCouncilCollectiveEvent_MemberExecuted {
    __kind: 'MemberExecuted'
    proposalHash: Uint8Array
    result: Type_49
}
 ...
 * A proposal was closed because its threshold was reached or after its duration was up.
 */
export interface TreasuryCouncilCollectiveEvent_Closed {
    __kind: 'Closed'
    proposalHash: Uint8Array
    yes: number
    no: number
 ...
 */
export type XcmTransactorEvent = XcmTransactorEvent_TransactedDerivative | XcmTransactorEvent_TransactedSovereign | XcmTransactorEvent_TransactedSigned | XcmTransactorEvent_RegisteredDerivative | XcmTransactorEvent_DeRegisteredDerivative | XcmTransactorEvent_TransactFailed | XcmTransactorEvent_TransactInfoChanged | XcmTransactorEvent_TransactInfoRemoved | XcmTransactorEvent_DestFeePerSecondChanged | XcmTransactorEvent_DestFeePerSecondRemoved
 ...
 */
export interface XcmTransactorEvent_TransactedSigned {
    __kind: 'TransactedSigned'
    feePayer: Uint8Array
    dest: V1MultiLocation
    call: Uint8Array
}
 ...
 */
export interface XcmTransactorEvent_DestFeePerSecondChanged {
    __kind: 'DestFeePerSecondChanged'
    location: V1MultiLocation
    feePerSecond: bigint
}
 ...
 */
export interface XcmTransactorEvent_DestFeePerSecondRemoved {
    __kind: 'DestFeePerSecondRemoved'
    location: V1MultiLocation
}
 ...
 */
export type RandomnessEvent = RandomnessEvent_RandomnessRequestedBabeEpoch | RandomnessEvent_RandomnessRequestedLocal | RandomnessEvent_RequestFulfilled | RandomnessEvent_RequestFeeIncreased | RandomnessEvent_RequestExpirationExecuted

export interface RandomnessEvent_RandomnessRequestedBabeEpoch {
    __kind: 'RandomnessRequestedBabeEpoch'
    id: bigint
...
export interface RandomnessEvent_RandomnessRequestedLocal {
    __kind: 'RandomnessRequestedLocal'
    id: bigint
    refundAddress: Uint8Array
    contractAddress: Uint8Array
    fee: bigint
...
export interface RandomnessEvent_RequestFulfilled {
    __kind: 'RequestFulfilled'
    id: bigint
}

export interface RandomnessEvent_RequestFeeIncreased {
    __kind: 'RequestFeeIncreased'
    id: bigint
    newFee: bigint
}

export interface RandomnessEvent_RequestExpirationExecuted {
    __kind: 'RequestExpirationExecuted'
    id: bigint
}
